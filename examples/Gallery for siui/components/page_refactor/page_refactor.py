...
from Qt.QtWidgets import QBoxLayout, QButtonGroup, QLabel, QSizePolicy, QWidget
...
class RefactoredWidgets(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        with self.titled_widgets_group as group:
            ...
            self.linear_edit_box3.setText("A powerful and artistic UI library based on Qt")
